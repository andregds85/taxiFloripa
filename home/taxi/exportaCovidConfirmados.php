...
$query = $db->query("select * from ocupainternadouti where status='CONFIRMADO' ORDER BY id ASC limit $inicio,$registros");

if($query->num_rows > 0){
    $delimiter = ";";
    $filename = "leitosUtiConfirmados" . date('Y-m-d') . ".csv";
